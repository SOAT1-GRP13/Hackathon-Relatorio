...
if (builder.Environment.IsProduction())
{
    ...
    builder.Configuration.AddAmazonSecretsManager("us-west-2", "relatorio-secret");
...
//builder.Services.AddAutoMapper(typeof(PontosMappingProfile));
...
builder.Services.AddHostedService<EspelhoPontoSubscriber>();
...
app.UsePathBase(new PathString("/relatorio"));
app.UseRouting();
